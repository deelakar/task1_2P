...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from S223693522, Deelaka Rathnayake");

	    // Locate chrome driver folder in the local drive.
	    System.setProperty("webdriver.chrome.driver", "C:\\chromedriver\\chromedriver.exe");
	    ...
	    sleep(5); // Sleep for 5 seconds after loading the page

	    // Resize the chromium browser window size to 640x480
	    System.out.println("Resizing browser window to 640x480");
	    driver.manage().window().setSize(new Dimension(640, 480));

	    sleep(2); // Sleep for 2 seconds

	    // Resize the chromium browser window size to 1280x960
	    System.out.println("Resizing browser window to 1280x960");
